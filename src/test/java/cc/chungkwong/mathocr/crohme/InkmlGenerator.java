...
import org.xml.sax.*;
/**
 * Generate InkML from JIIX
 *
 * To evaluate label graph use `mml2symlg
 * ../datasets/results/img2014/result_mml/
 * ../datasets/results/img2014/result_lg/` and `evaluate
 * ../datasets/results/img2014/result_lg/
 * ../datasets/TC11_package/CROHME2014_data/TestEM2014LG`
 *
...
//		}
	...
	public static String convert(String jiix,String name,boolean lg){
		...
		try{
			Expression expr=new JiixFormat().decode(jiix);
...
//		generate(new File(Crohme.DIRECTORY_RESULT+"/2016"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2014"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2014"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2016"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2016"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/raw2014"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/raw2014"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/raw2016"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/raw2016"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2016_crohme"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2016_crohme"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/test2016"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/test2016"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2016_std"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/big2016_std"),false);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/raw2016"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/img2016_small"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/img2016_std"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/img2016_crohme"),true);
//		generate(new File(Crohme.DIRECTORY_RESULT+"/img2014_small"),true);
